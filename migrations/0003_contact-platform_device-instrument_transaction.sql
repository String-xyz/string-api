...
CREATE TABLE transaction (
  ...
  reciept_amount BIGINT DEFAULT 0,
  reciept_asset UUID REFERENCES asset (id),
  reciept_value BIGINT DEFAULT 0,
  reciept_user_id UUID NOT NULL REFERENCES string_user (id),
  reciept_instrument_id UUID NOT NULL REFERENCES instrument (id),
