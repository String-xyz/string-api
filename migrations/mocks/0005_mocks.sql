...
-- -------------------------------------------------------------------------
-- -- INSTRUMENT -----------------------------------------------------------
-- DELETE FROM instrument WHERE id = '13438963-f5e7-47c4-a790-ebca3e3bf915';
-- DELETE FROM instrument WHERE id = 'ab6a2d66-ad4c-43f4-adf9-c0cd3282492c';

-- -------------------------------------------------------------------------
-- -- DEVICE ---------------------------------------------------------------
-- DELETE FROM device WHERE id = '073f5a88-9223-4554-a7ce-11d358123a21';

-- -------------------------------------------------------------------------
-- -- STRING_USER ----------------------------------------------------------
-- DELETE FROM string_user WHERE id = '0e837b73-55cf-43ff-9b1e-0d8258eec978';
